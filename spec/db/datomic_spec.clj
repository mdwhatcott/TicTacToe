...
(describe "The Datomic Database"
  ...
  (it "stores moves made with the corresponding game"
    (with-redefs [conn (empty-database)]
      ...
      (establish-new-game "game-1" 3 :human :human)
      (establish-new-game "game-2" 3 :human :human)
      (associate-move "game-1" 0 2)                         ; game-1, move 1
      (associate-move "game-1" 1 1)                         ; game-1, move 2
      (associate-move "game-2" 0 5)                         ; game-2, move 1
      (conclude-game "game-2")
