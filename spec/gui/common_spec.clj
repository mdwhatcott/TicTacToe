...
(describe "Bounding Boxes"
  ...
  (it "identifies when a containing coordinate"
    (should= true (bounded? [1 1] (bounding-cube [5 5] 10)))
    (should= true (bounded? [9 9] (bounding-cube [5 5] 10)))
    (should= false (bounded? [10 10] (bounding-cube [5 5] 10)))
    (should= false (bounded? [1 11] (bounding-cube [5 5] 10)))
    )
  )
